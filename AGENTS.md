Current reviewed publication candidate: [DEV14.3 upgraded pickaxe motion](docs/premium-polish/dev14-native-worn/DEV14.3.md). Exact game source1632526b0cb675e5efd5709b0e55a6ab7ef970d9; validation-only source49668d1139dd44118f333c775b4b4c02881e7722. Run35706535761 passed on the immutable export from35704702742. All eight original pickaxes use the approved native hero/motion; fast Comet transitions are corrected. Mac DPR3 windows56.27–59.32rAF FPS; sampled visual review8.5/10; physical iPhone remains unverified. Publication is pending its workflow and public hash receipt. Use the existing authenticated GitHub connection: no new login is needed. Mats approved public upload/publication after gates ("Alltid"). Do not repeat this unchanged export or its passing tests.
