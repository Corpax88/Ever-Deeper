Current accepted implementation candidate: [DEV15 locked Skills menu and active stamina](docs/premium-polish/skills-dev15/HANDOFF.md). Exact game source b788ca7484bc99bb210255851dacca35db501d5f on codex/locked-skills-ui-20260922; main holds publication/evidence. Run35795605519 passed exported core/Skills, Mac mobile touch/rendering, and ordinary Apple WebKit startup. Independent final-image review is accepted; publish only the exact reviewed DEV15 artifact through .github/skills-dev15/publish.py, and retain LIVE/trial/save identity. Mats's standing public-upload/publication authorization persists; no new login required. Physical iPhone remains unverified.
