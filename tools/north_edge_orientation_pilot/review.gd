...
const IDENTITY_PATHS: Array[String] = [
	...
	"res://tools/north_edge_orientation_pilot/deep_candidate.gd",
	"res://tools/north_edge_orientation_pilot/review.gd",
	"res://tools/north_edge_orientation_pilot/README.md",
]
var output: String = ""
...
func _run() -> void:
	...
	_restore_controls()
	print("NORTH_EDGE_ORIENTATION_REVIEW_COMPLETE " + JSON.stringify({"pairs":1, "failures":failures, "visual_approval":false}))
	quit()
...
func _reject(message: String) -> void:
	...
	_save_report()
	_restore_controls()
	push_error("NORTH_EDGE_ORIENTATION_REVIEW_FAIL " + message)
	quit(2)
