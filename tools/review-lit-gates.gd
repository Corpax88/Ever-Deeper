...
func run() -> void:
	...
	FileAccess.open(output_dir.path_join("gate-review.json"), FileAccess.WRITE).store_string(JSON.stringify({"passed":true,"package_version":"0.46.9-dev.6","cases":report,"paired":reviewer.cases}, "\t"))
