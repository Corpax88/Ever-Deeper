...
`HERO_V28_CAPTURE=1 CAPTURE_END=192 node tools/capture-web.mjs ...` captures all
gear/direction/pose combinations, outfits and worlds in the actual exported game.
