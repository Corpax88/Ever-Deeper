...
const SOURCE='9d52cb37a0a7162f0950a93610fa5ce5a4489171';
const BRANCH='refs/heads/codex/nonindexed-warmup-webkit-20260917';
const IDENTITY='44a74c2993d28ed17b2f566beaac58ca8f12bd7faaf169e8349027b8390cb822';
...
try {
  ...
  if(identity.sourceSha!==SOURCE||identity.runId!=='35253727925'||Object.keys(identity.devFiles).length!==9)throw Error('Wrong nine-file source');
  const verified={};
  ...
  if(result.pck_sha256!=='6b0f5583b4fecfea416e8bf1d67d4a477be41b8eb3aef38a4dd60e1c006ee2a0')throw Error('Wrong exact full warmup candidate PCK');
