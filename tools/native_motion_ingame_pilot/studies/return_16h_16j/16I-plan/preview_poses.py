...
CANDIDATE = Path('/tmp/pivot-return-16I-plan/pivot_return_motion.py')
...
assert sha(motion_source) == '1fc51407bd69b90b993a688be9aa631868ffae1af134f21f33f320864a86aaff'
...
try:
    phases = (.720689655172414, .0, .130952380952381, .231092436974790, .288095238095238)
    for phase in phases:
