...
func _run() -> void:
	...
	main.get_node("EndlessDescentWorld/Player/Visual").set_script(load("res://tools/native_motion_ingame_pilot/studies/simple_swing_17/loop_visual.gd"))
	root.add_child(main)
	current_scene = main
	...
	file.close()
	print("SIMPLE_SWING_GAME_COMPLETE ",hits," ",damage)
