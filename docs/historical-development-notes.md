...
Current release: **Ever Deeper v0.43.1** / **DEV v0.43.1-dev.6**.
...
the DEV-only premium commerce pass across all eight active shops, and the
four-biome resource-node readability/transparency fixes.
