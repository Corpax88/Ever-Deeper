...
func _process(delta: float) -> void :
	...
	if stamp != 0: QAProfile.record("main._process", Time.get_ticks_usec() - stamp)
...
func _update_visual_guide() -> void :
	var stamp: int = Time.get_ticks_usec() if QAProfile.enabled else 0
	_qa_impl_update_visual_guide()
	if stamp != 0: QAProfile.record("main._update_visual_guide", Time.get_ticks_usec() - stamp)

func _qa_impl_update_visual_guide() -> void :
...
func _update_minimap() -> void :
	var stamp: int = Time.get_ticks_usec() if QAProfile.enabled else 0
	_qa_impl_update_minimap()
	if stamp != 0: QAProfile.record("main._update_minimap", Time.get_ticks_usec() - stamp)

func _qa_impl_update_minimap() -> void :
...
func _refresh_hud() -> void :
	var stamp: int = Time.get_ticks_usec() if QAProfile.enabled else 0
	_qa_impl_refresh_hud()
	if stamp != 0: QAProfile.record("main._refresh_hud", Time.get_ticks_usec() - stamp)

func _qa_impl_refresh_hud() -> void :
	_update_presented_gold_labels()
