"""Build an isolated integrated candidate from the immutable DEV15.9 PCK.

Preserve every original resource except explicitly listed source remaps.
Verify every resource digest and use Godot 4.7.2 pack format.
"""
...
def main(source, work):
    expected = json.loads((ROOT/'.github/integrated-candidate/baseline.json').read_text())
