...
BASE={'live':json.loads((ROOT.parent/'performance-v0469/review.json').read_text())['files']['live'], 'dev':json.loads((ROOT.parent/'dev-teamwork/review.json').read_text())['files']}
