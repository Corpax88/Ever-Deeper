...
const report={kind:'diagnostic',source_commit:'9989805a329373af6c19dc5cde21e23205d87ea5',files,normal_startup:true,fixture_args:[],physical_iphone:false,events:[],samples:[],images:[]};
...
try{
 ...
 await page.waitForFunction(()=>window.everDeeperVersion==='1.0.0-dev.14',null,{timeout:180000});
