"""Publish only the exact visually reviewed surface candidate and preserve LIVE."""
...
assert review['viewport']==[932,430] and review['capture_count']==25
...
if '--verify-public' in sys.argv:
 ...
 print('All 18 public files match: original LIVE preserved, reviewed surface DEV published.')
else:
 ...
 print('Both previous versions verified; reviewed surface and unchanged LIVE packaged atomically.')
