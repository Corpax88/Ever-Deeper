"""Publish only the exact reviewed DEV15.1 artifact; preserve LIVE and Worn trial."""
...
def reviewed():
 ...
 require({'manifest.json','baseline.json','native-input.json','evidence/browser.json','evidence/core.json','evidence/build.json','evidence/skills-core.log','evidence/webkit.json','evidence/independent-review.json','publish.py','../workflows/publish-hud-dev15-1.yml','../native-flow-trial/bundle.json'}<=set(review['reviewed_files']),'Missing pinned evidence')
 require(baseline['displayed_dev_version']=='1.0.0-dev.15' and set(baseline['files'])=={'live','dev'},'Unexpected previous release')
 ...
 require({'held-drag-cancels-tooltip-844','held-drag-cancels-tooltip-667','enlarged-hud-bindings','larger-gameplay-controls-3-2','hud-top-and-context-clear-3-2','larger-gameplay-controls-844','larger-gameplay-controls-667','hud-top-and-context-clear-844','hud-top-and-context-clear-667','hover-stat-mining','hover-stat-running','hover-stat-carrying','hover-stat-prospecting','hover-stat-stamina','long-press-stat-844','long-press-stat-667','short-tap-has-no-sticky-tooltip-844','short-tap-has-no-sticky-tooltip-667','drag-cancels-tooltip-844','drag-cancels-tooltip-667','graphical-mac-renderer','actual-joystick-trains-and-drains','active-rest-recovers','menu-freezes-stamina-and-training','embedded-map-survives-resize','small-phone-close-target','skills-hides-developer-overlay','closing-restores-developer-controls','fatigue-is-mild','open-during-mining-pauses-damage','resume-restores-movement','no-runtime-errors','02-surface-touch','10-exhausted-moss-touch','11-endless-touch','04-approved-skills-844','07-approved-skills-667','08-inventory','09-settings','09-settings-back','12-resumed-game'}<=names,'Missing affected behavior or target captures')
...
def prepare(work,candidate):
 ...
 require({label:want['name'] for label,want in review['artifacts'].items()}=={'candidate':'dev15-1-candidate','build':'dev15-1-build-review','browser':'dev15-1-browser-review'},'Required artifact set incomplete')
 ...
 require(review['artifacts']['candidate']['name']=='dev15-1-candidate','Wrong candidate artifact')
 ...
 print('HUD_DEV15_1_STAGED reviewed_files=9 preserved=18')
def verify(output):
