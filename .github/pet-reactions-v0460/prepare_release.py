...
assert review['passed'] is True and review['viewport']==[932,430]
assert review['production_reaction_frames']==80 and review['dev_journal_states']==12
assert review['gameplay_checks']==859 and review['gameplay_passed']==['dev','live']
...
if '--verify-public' in sys.argv:
 ...
 print('Verified all 18 public files: DEV 0.46.0-dev.2 and production 0.46.0')
else:
