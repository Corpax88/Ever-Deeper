...
def reviewed():
 ...
 require({'manifest.json','baseline.json','native-input.json','evidence/browser.json','evidence/core.json','evidence/build.json','evidence/skills-core.log','evidence/webkit.json','evidence/independent-review.json','publish.py','../workflows/publish-world-dev15-5.yml','../native-flow-trial/bundle.json'}<=set(review['reviewed_files']),'Missing pinned evidence')
 require(baseline['displayed_dev_version']=='1.0.0-dev.15.4' and set(baseline['files'])=={'live','dev'},'Unexpected previous release')
 ...
 require({'graphical-mac-renderer','larger-gameplay-controls-844','larger-gameplay-controls-667','larger-gameplay-controls-3-2','hud-top-and-context-clear-844','hud-top-and-context-clear-667','hud-top-and-context-clear-3-2','approved-icon-opens-skills-844','approved-icon-opens-skills-667','approved-icon-opens-skills-3-2','hud-844','hud-667','hud-3-2','hud-moss-844','touch-mining-after-menu','no-runtime-errors','relocated-quarry-and-retired-surface-store','relocated-quarry-mining','road-walkable-after-relocation','no-wayfarer-mossMine','no-wayfarer-moonMine','no-wayfarer-emberMine','no-wayfarer-starMine','quarry-full-844','quarry-full-667','quarry-stage-120','quarry-stage-0','hover-stat-mining','hover-stat-running','hover-stat-carrying','hover-stat-prospecting','hover-stat-stamina','tooltip-mining-844','tooltip-running-844','tooltip-carrying-844','tooltip-prospecting-844','tooltip-stamina-844','skill-bars-844','skill-bars-667','skill-bars-3-2','skill-bars-edges','zero-near-full-and-cap','xp-rollover','skills-edges-844','skills-rollover-844','long-press-stat-844'}<=names,'Missing affected HUD behavior or target captures')
...
def prepare(work,candidate):
 ...
 require({label:want['name'] for label,want in review['artifacts'].items()}=={'candidate':'dev15-5-candidate','build':'dev15-5-build-review','browser':'dev15-5-browser-review'},'Required artifact set incomplete')
 ...
 require(review['artifacts']['candidate']['name']=='dev15-5-candidate','Wrong candidate artifact')
 ...
 print('WORLD_DEV15_5_STAGED reviewed_files=9 preserved=18')
def verify(output):
 ...
 for attempt in range(10):
  ...
  if not pending:
   ...
   print('WORLD_DEV15_5_PUBLIC_VERIFY_OK files=27');return
