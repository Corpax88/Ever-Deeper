...
const version='1.0.0-dev.15.3',files=JSON.parse(fs.readFileSync(path.join(web,'manifest.json')));
...
try{
 ...
 await command('skills_fixture');await longPressTip('844');await tap('skills_close');await ready();
