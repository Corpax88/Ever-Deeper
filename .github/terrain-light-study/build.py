"""Build an isolated terrain light-culling diagnostic while preserving the exact approved native hero/tool resources."""
...
def build(godot,work):
 ...
 expected=json.loads((ROOT/'.github/native-light-dev15-9/baseline.json').read_text())
