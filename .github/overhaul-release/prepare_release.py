...
base=json.loads((source/'release-baseline.json').read_text())
...
assert review['viewport']==[932,430] and review['capture_count']==303
assert review['gameplay_checks']==776 and review['gameplay_passed'] is True
...
if '--verify-public' in sys.argv:
 ...
 print('All 18 public files match: original LIVE preserved, reviewed overhaul DEV published.')
else:
 ...
 print('Both previous versions verified; reviewed overhaul and unchanged LIVE packaged atomically.')
