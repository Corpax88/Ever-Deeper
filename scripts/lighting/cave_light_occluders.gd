...
var qa_use_occupancy_revision: bool = false
...
func refresh() -> void:
	...
	elif qa_use_occupancy_revision and not world.has_method("_terrain_is_solid") and world.has_method("_terrain_occupancy_revision"):
