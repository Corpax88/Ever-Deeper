...
const MINE_ASSETS: = {
	"mossvein": {
		"depth1": {
			...
			"wall": "res://assets/mossvein/cave-wall.png", 
			"unbreakable_wall": "res://assets/mossvein/unbreakable-wall.png", 
	...
	"moonglass": {
		"depth1": {
			...
			"wall": "res://assets/moonglass/wall.png", 
			"unbreakable_wall": "res://assets/moonglass/unbreakable-wall.png", 
	...
	"emberdeep": {
		"depth1": {
			...
			"wall": "res://assets/emberdeep/wall.png", 
			"unbreakable_wall": "res://assets/emberdeep/unbreakable-wall.png", 
	...
	"starfall": {
		"depth1": {
			...
			"wall": "res://assets/starfall/wall.png", 
			"unbreakable_wall": "res://assets/starfall/unbreakable-wall.png", 
